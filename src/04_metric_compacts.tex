...
\begin{proof}
    ...
    Когда-то в детстве мы занимались бесконечным делением пополам. Тут будем делать то же самое.
...
\begin{proof}[2 утверждение]
    $\Leftarrow$ \\
    $(X, \rho)$ -- полное, $A$ -- вполне ограничено, тогда по свойству \hyperref[chap4:props]{4.1} ($\overline{A}$ -- вполне ограничено $\: \wedge \:$ $\overline{A}$ -- замкнутое в $X \Rightarrow \overline{A}$ -- полное)
